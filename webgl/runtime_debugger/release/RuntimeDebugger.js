...
var ASM_CONSTS = {
 ...
 301844: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 301927: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 301996: () => { return window.innerWidth; },  
 302026: () => { return window.innerHeight; }
};
